...
The `chance_event()` function was used to calculate the time series occurrence of risk events. This function required two main arguments specified in input tables which are the probability that a particular risk event will happen in a given year and the time line for simulation. 
