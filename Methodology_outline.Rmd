...
We applied the `make_variables` function to `estimate_read_csv`, the input data table, to generate one random number for each variable.These numbers are not used in the simulation, but they allow running all the code in the model for testing and troublesshooting purposes.
