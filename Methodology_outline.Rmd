...
The value varier function `vv()` was used to produce a time series containing variation from a specified mean and a desired coefficient of variation, which both were parameters in the input tables. 
